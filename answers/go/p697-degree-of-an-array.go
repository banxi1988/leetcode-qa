...
func findShortestSubArray(nums []int) int {
	...
	for _, num := range nums {
		degree, _ := degreeMap[num]
		degree++
		degreeMap[num] = degree
		if degree > maxDegree {
			maxDegree = degree
		}
	}
